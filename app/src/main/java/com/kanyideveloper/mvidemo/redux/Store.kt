...
/**
 * A [Store] is a state container for a given screen.
 * @param [initialState] This is the initial state of the screen when it is first created
 * @param [reducer] a system for taking in the current state, and a new action, and outputting the updated state
