...
/**
 * A [Middleware] is any class that deals with side effects of actions. This can be
...
interface Middleware<S: State, A: Action> {
     ...
     * call this with a _new_ action, and not trigger the same action or risk ending up in a loop
     *
     *
     */
    suspend fun process(
